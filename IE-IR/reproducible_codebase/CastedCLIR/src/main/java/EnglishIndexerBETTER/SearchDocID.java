...
public class SearchDocID {
    public static void main(String[] args) throws IOException, ParseException, ClassNotFoundException {
        ...
        String indexDir = "/Users/ramraj/Projects/better-ir/Eval-1.0-BETTER-Jan_Mar/Building-refactored-Docker-systems/IndexDirs/English_IndexDir";
        ...
        Query q = new QueryParser(prop.getProperty("ENG_FIELD_BODY"), analyzer).parse(queryStr);
        ...
        for (int i = 0; i < hits.length; ++i) {
            ...
            String documentUUID = d.get(prop.getProperty("ENG_FIELD_ID"));
