...
import Utils.BETTERTuningQueryParser;
import Utils.BETTERTuningRequest;
import Utils.BETTERTuningTask;
...
public class MainSearcher {
    ...
    public BETTERTuningQueryParser BETTERMTedQueryParser;
    ...
    public MainSearcher(Properties prop,
        ...
        BETTERMTedQueryParser = new BETTERTuningQueryParser(this.prop, this.queryPath, this.logger);
    ...
    private List<BETTERTuningTask> constructQueries() { // Loading the TREC format of queries
    ...
    public void retrieveAndRank() throws Exception {
        ...
        for (BETTERTuningTask query : queries) {
            ...
            for (BETTERTuningRequest BETTERMTedRequest : query.requests) {
                ...
                if (modelChoiceInt == 3) { // RM3
                    ...
                    topDocs = rm3Searcher.search(refactoredQuery, numHits, query, BETTERMTedRequest, prevReqQETermsSet);
                } else { // BM25
...
//                        documentInfo.put("docSentenceSegments", unSerialize(d.getBinaryValue(prop.getProperty("FIELD_SENT_SEG")).bytes) );
    ...
    public static void main(String[] args) throws Exception {
        ...
        args[1] = "RM3";
        args[2] = "/Users/ramraj/better-ir/English-Turkey-run/BETTERIndexDir";
        args[3] = "/Users/ramraj/better-ir/English-Turkey-run/Eval/environment-setup/Parameter-Tuning/dry-run-topics.hitl.json";
        args[4] = "output/output.txt";
        args[5] = "output/outputToIE.json";
        args[6] = "output/log.log";
        args[7] = "JHU.EmoryCLIRDryRun";

        Properties prop = new Properties();
        prop.load(new FileReader(args[0]));

        MainSearcher mainSearcher = new MainSearcher(prop, args[1], args[2], args[3], args[4], args[5], args[6], args[7]);
