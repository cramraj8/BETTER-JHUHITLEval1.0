...
public class RM3Searcher extends IndexSearcher {
    ...
    // @Override
    public TopDocs search(Query query, int n, BETTERTuningTask betterTask, BETTERTuningRequest betterRequest, Set<String> prevReqQETermsSet) throws IOException {
    ...
    public ScoreDoc[] reRank(ScoreDoc[] initialResults, Query q, BETTERTuningTask bettermTedTask, BETTERTuningRequest betterRequest) throws IOException {
