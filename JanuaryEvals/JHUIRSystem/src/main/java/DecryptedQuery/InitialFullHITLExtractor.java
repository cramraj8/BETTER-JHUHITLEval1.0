...
public class InitialFullHITLExtractor {
    ...
    public InitialFullHITLExtractor(Properties prop,
        ...
        betterQueryParser = new BETTERQueryParser(this.prop, this.queryPath, this.logger);
...
//        this.pipeline = new StanfordCoreNLP(this.coreNLPprops);
    ...
    private Query queryGeneratorEnh(BETTERTask betterTask, BETTERRequest betterRequest, ArrayList<String> taskDocs) throws IOException, QueryNodeException {
        ...
        /** ============================ Task Info ============================================== */
        fullQueryText.append(betterTask.task_title).append(" ");
        fullQueryText.append(betterTask.task_stmt).append(" ");
        fullQueryText.append(betterTask.task_narr).append(" ");

        temporaryQueryText.append(betterTask.task_title).append(" ");
        temporaryQueryText.append(betterTask.task_stmt).append(" ");
        temporaryQueryText.append(betterTask.task_narr).append(" ");
        ...
        String constructedEngQueryText;
        ...
        try {
            ...
            for (int i=0; i < Math.min(1000, qToknsLIST.length); i++) truncatedQText.append(qToknsLIST[i]).append(" ");
...
//            }
    ...
    public void retrieveAndRank() throws Exception {
        ...
        for (BETTERTask query : queries) {
            ...
            for (BETTERRequest betterRequest : query.requests) {
                ...
                Query refactoredQuery = queryGeneratorEnh(query, betterRequest, query.task_docs);
                ...
                if (modelChoiceInt == 3) { // RM3
                    RM3SearcherDecryption rm3SearcherDecryption = new RM3SearcherDecryption(indexReader, logger, this);
                    topDocs = rm3SearcherDecryption.search(refactoredQuery, relevanceTaskScoreDocs, relevanceRequestScoreDocs, numHits, betterRequest);
    ...
    public static void main(String[] args) throws Exception {
        ...
        args[1] = "RM3";
        args[2] = "/Users/ramraj/better-ir/English-Turkey-run/Eval/environment-setup/English-Indexing/ENGLISH_INDEX_DIR";
        // args[3] = "/Users/ramraj/better-ir/English-Turkey-run/Eval/environment-setup/Decrypted-Query/query-formulation-output/generated-query.en.json";
        args[3] = "/Users/ramraj/better-ir/English-Turkey-run/Eval/environment-setup/Decrypted-Query/ir-hitl-performer-tasks.json";
        args[4] = "/Users/ramraj/better-ir/English-Turkey-run/Eval/environment-setup/Decrypted-Query/eng-training-initial-retrievals/full-hitl-enh-retrievals.txt";
        args[5] = "/Users/ramraj/better-ir/English-Turkey-run/Eval/environment-setup/Decrypted-Query/eng-training-initial-retrievals/full-hitl-enh-retrievals-QE-output.txt";
        args[6] = "/Users/ramraj/better-ir/English-Turkey-run/Eval/environment-setup/Decrypted-Query/eng-training-initial-retrievals/full-hitl-enh-retrievals-outputToIE.json";
        args[7] = "/Users/ramraj/better-ir/English-Turkey-run/Eval/environment-setup/Decrypted-Query/eng-training-initial-retrievals/full-hitl-enh-retrievals-log.log";
        args[8] = "JHU.EmoryHITLDryRun";

        Properties prop = new Properties();
        prop.load(new FileReader(args[0]));

        InitialFullHITLExtractor initialFullHITLExtractor = new InitialFullHITLExtractor(prop, args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8]);
        initialFullHITLExtractor.retrieveAndRank();
    }
}
