...
public class RM3Searcherv1 extends IndexSearcher {
    ...
    String stopFilePath;
    List stopWordsList;
    public BETTERCLIRSearcherWSentSegRM3 mainSearcher;
    public EnglishAnalyzer englishAnalyzer;
    public EnglishStemmer englishStemmer;
    public Logger logger;
    public RM3Searcherv1(IndexReader r, Logger logger, BETTERCLIRSearcherWSentSegRM3 mainSearcher) {
        super(r);
    ...
    // @Override
    public TopDocs search(Query query, int n, BETTERMTedRequest betterRequest) throws IOException {
