...
public class RM3Searcherv1 extends IndexSearcher {
    ...
    public RM3Searcherv1(IndexReader r, Logger logger, MainSearcher mainSearcher) {
        super(r);
    ...
    private ScoreDoc[] mergeTaskReqScoreDocs(ScoreDoc[] labelRelevanceTaskScoreDocs, ScoreDoc[] labelRelevanceRequestScoreDocs) {
        ...
        if (labelRelevanceTaskScoreDocs == null) return mergedNewScoreDocs.toArray(new ScoreDoc[mergedNewScoreDocs.size()]);;
    ...
    // @Override
    public TopDocs search(Query query, ScoreDoc[] labelRelevanceTaskScoreDocs, ScoreDoc[] labelRelevanceRequestScoreDocs, int n, BETTERMTedRequest betterRequest) throws IOException {
    ...
    public ScoreDoc[] reRank(ScoreDoc[] initialResults, Query q, BETTERMTedRequest betterRequest) throws IOException {
