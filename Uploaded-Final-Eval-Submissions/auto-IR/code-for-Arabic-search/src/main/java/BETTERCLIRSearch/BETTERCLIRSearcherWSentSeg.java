...
public class BETTERCLIRSearcherWSentSeg {
    ...
    public BETTERCLIRSearcherWSentSeg(Properties prop,
    ...
    public static void main(String[] args) throws Exception {
        ...
        args[3] = "/Users/ramraj/better-ir/English-Turkey-run/Eval/environment-setup/Arabic-Searching/output_queries.json.ar";
        args[4] = "/Users/ramraj/better-ir/English-Turkey-run/Eval/environment-setup/Arabic-Searching/output_withSentSeg/OUTPUT.txt";
        args[5] = "/Users/ramraj/better-ir/English-Turkey-run/Eval/environment-setup/Arabic-Searching/output_withSentSeg/outputToIE.json";
        args[6] = "/Users/ramraj/better-ir/English-Turkey-run/Eval/environment-setup/Arabic-Searching/output_withSentSeg/log.log";
        args[7] = "JHU.EmoryCLIRDryRun";

        Properties prop = new Properties();
        prop.load(new FileReader(args[0]));

        BETTERCLIRSearcherWSentSeg betterclirSearcherWSentSeg = new BETTERCLIRSearcherWSentSeg(prop, args[1], args[2], args[3], args[4], args[5], args[6], args[7]);
        betterclirSearcherWSentSeg.retrieveAndRank();
    }
