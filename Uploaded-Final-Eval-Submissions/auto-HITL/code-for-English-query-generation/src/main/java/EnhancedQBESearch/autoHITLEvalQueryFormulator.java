...
import BETTERUtils.BETTERQueryParserEvalautoHITL;
...
public class autoHITLEvalQueryFormulator {
    public Properties prop;
    public Logger logger;
    public String queryFilename;
    public BETTERQueryParserEvalautoHITL betterQueryParserEvalautoHITL;
    ...
    private List<BETTERTask> constructQueries() { // Loading the TREC format of queries
        return betterQueryParserEvalautoHITL.queryFileParse();
    }

    public autoHITLEvalQueryFormulator(Properties prop, String indexDirPath, String queryFilename, String outputWriteFile, String searcherLogFilename) throws IOException {
        this.prop = prop;
        ...
        this.betterQueryParserEvalautoHITL = new BETTERQueryParserEvalautoHITL(this.prop, queryFilename, this.logger);
...
//        args[2] = "/Users/ramraj/better-ir/English-Turkey-run/Eval/environment-setup/Freezing-autoHITL/turkey-run-hitl-tasks-critical.json";
//        args[3] = "/Users/ramraj/better-ir/English-Turkey-run/Eval/environment-setup/Freezing-autoHITL/query/output-c.json";
//        args[4] = "/Users/ramraj/better-ir/English-Turkey-run/Eval/environment-setup/Freezing-autoHITL/query/log-c.log";
        ...
        args[0] = "actual.config.properties";
        args[1] = "/Users/ramraj/better-ir/English-Turkey-run/Eval/environment-setup/English-Indexing/ENGLISH_INDEX_DIR";
        args[2] = "/Users/ramraj/better-ir/English-Turkey-run/Eval/environment-setup/Decrypted-Query/ir-hitl-performer-tasks.json";
        ...
        args[4] = "/Users/ramraj/better-ir/English-Turkey-run/Eval/environment-setup/Decrypted-Query/query-formulation-output/query-generation.log";

        Properties prop = new Properties();
        prop.load(new FileReader(args[0]));
        autoHITLEvalQueryFormulator autoHITLEvalQueryFormulator = new autoHITLEvalQueryFormulator(prop, args[1], args[2], args[3], args[4]);
        autoHITLEvalQueryFormulator.mainEngQueryConstruction();
    }
}
